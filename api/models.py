...
class Review(models.Model):
    ...
    pub_date = models.DateTimeField('review pub date', auto_now_add=True, db_index=True)
...
class Comment(models.Model):
    ...
    pub_date = models.DateTimeField('comment pub date', auto_now_add=True, db_index=True)
